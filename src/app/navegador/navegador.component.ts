...
export class NavegadorComponent implements OnInit,AfterViewInit {
  ...
  constructor(public authService: AuthService, private translocoService: TranslocoService, private cookieService: CookieService) {
 ...
 toggleDarkTheme(): void {
  ...
  ngOnInit() {
    if(sessionStorage.getItem('user'))this.isLog = true
